...
<!-- about -->
	<div class="services">
		<div class="container">
				<form id="add_complain_form" action="/manager/complain/doAdd.do" method="post">
					<div class="row">
					  <div class="col-xs-4">
					...
					<div class="form-group">
					  ...
					  <textarea id="comp_message" name="comp_message" style="height:300px;" class="form-control" rows="3" placeholder="Enter ..." ></textarea>
					</div>
					<div class="col-xs-3">
					...
					<div class="col-xs-6" style="text-align:center;">
						...
						<button type="submit" id="add_complain_btn" class="btn btn-primary" style="margin-left:5px;">确定</button> 
					</div>
					<div class="col-xs-3">	
