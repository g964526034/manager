  ...
  <div class="register-box-body">
	<div class="box-header with-border">
       <c:if test="${!empty info }">
			  ...
			  <strong>提示!</strong> 密码修改成功
			</div>
			<script>
				setTimeout(function(){
					location.href ="/manager/user/changepwd.do";
				},3000);
			</script>
	   </c:if>
	</div>
    <form id="changepwd_user_form" method="POST" action="/manager/user/doChangepwd.do">
      ...
      <div class="form-group has-feedback">
        <input id="pwd" name="pwd" type="password" class="form-control" placeholder="请输入当前密码">
        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input id="newpwd" name="newpwd" type="password" class="form-control" placeholder="设置密码">
        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button id="changepwd_user_btn" type="submit" class="btn btn-primary btn-block btn-flat">修改</button>
        </div>
        <!-- /.col -->
      </div>
    </form>

    <a href="/manager/user/tellogin.do" class="text-center">手机号登录</a>
    <a href="/manager/user/emaillogin.do" class="text-center">邮箱登录</a>
  </div>
  <!-- /.form-box -->
</div>
<!-- /.register-box -->
