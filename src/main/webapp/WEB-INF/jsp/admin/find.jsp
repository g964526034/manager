  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <form method="POST" action="/manager/app/user/update">
        	<div class="box-body">
	          <div class="box">
	            <div class="col-xs-3">
				  ...
				  <div class="col-xs-6">
					<div class="box-body">
					  ...
					  <input readonly name="gender" id="gender" class="form-control" type="text" placeholder="性别" value="${admin.gender == 1 ? '男' : '女' }" >
					  <br/>
					  <label for="marriage">婚姻状况</label>
					  <div class="form-group">
						  <select disabled name="marriage" class="form-control">
					  ...
					  <input readonly name="work" id="work" class="form-control" type="text" placeholder="工作" value="${admin.work }">
					  <br/>
					  <label for="salary">薪水</label>
					  <input readonly name="salary" id="salary" class="form-control" type="text" placeholder="薪水" value="${admin.salary }">
					  <br/>
					  <label for="privilege">权限</label>
					  <div class="form-group">
						  <select disabled name="privilege" class="form-control">
							...
							<option value="2" <c:if test="${admin.privilege == 2 }"> selected </c:if>>维修管理员</option>
						  </select>
					  </div>
	        ...
	        <div class="box-footer">
				...
				<div class="col-xs-6" style="text-align:center;">
					<a href="/manager/admin/doBrowse" type="button" class="btn btn-default" style="margin-right:5px;">返回</a>
					<a href="/manager/admin/edit.do?id=${admin.id}" type="button" class="btn btn-primary" style="margin-left:5px;">编辑</a> 
				</div>
