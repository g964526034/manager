    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title"><b>您好，管理员${sessionScope.admin.realName }</b></h3>
        ...
        <div class="box-body">
			<div class="jumbotron" style="height:600px;background:url(/manager/static/background/bg1.jpg);background-position: center center;background-repeat: no-repeat;">
				<h1 style="text-align:center;">欢迎使用依晨小区物业管理系统</h1>
				</br>
			</div>
        </div>
        <!-- /.box-body -->
