        ...
        <div class="box-body">
			...
			<form id="response_fix_form" action="/manager/fix/doResponse.do" method="post">
				...
				<div  class="form-group">
				  ...
				  <textarea readonly name="response" id="response" style="height:175px;" class="form-control" rows="3" placeholder="Enter ..." >${fix.response }</textarea>
	            </div>
	            <div class="col-xs-3">
								  
				</div>
				<div class="col-xs-6" style="text-align:center;">
					<a href="/manager/fix/doBrowse.do" type="button" class="btn btn-default" style="margin-right:5px;">返回</a>
					<c:if test="${sessionScope.admin.realName == complain.admin.realName || complain.admin.realName == '' }">
						<a href="/manager/fix/edit.do?id=${fix.id}" type="button" class="btn btn-primary" style="margin-left:5px;">编辑</a> 
					</c:if>
				</div>
				<div class="col-xs-3">	
