  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <form id="update_announce_form" method="POST" action="/manager/announce/doUpdate.do">
        	<div class="box-body">
	            <div class="row">
			  <div class="col-md-6">
				
				  <div class="form-group">
					<label for="id" style="text-align:left;padding-left:20px;" class="col-sm-3 control-label">ID</label>
					<div class="col-sm-9">
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group">
					<label for="title" style="text-align:left;padding-left:20px;" class="col-sm-3 control-label">公告标题</label>
					<div class="col-sm-9">
			...
			<div class="form-group">
			  ...
			  <textarea id="content" name="content" style="height:300px;" class="form-control" rows="3" placeholder="Enter ..." >${announce.content }</textarea>
            </div>
	        </div>
	        <!-- /.box-body -->
	        <div class="box-footer">
				...
				<div class="col-xs-6" style="text-align:center;">
					<a href="/manager/announce/doBrowse.do" type="button" class="btn btn-default" style="margin-right:5px;">返回</a>
