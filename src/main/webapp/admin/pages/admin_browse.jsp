    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          ...
          <a href="admin_add.jsp" style="background-color:#2F4F4F;border-color:#D3D3D3;" class="btn btn-info btn-flat pull-right">添加管理员</a>
        </div>
        <div class="box-body">
          <div class="box">
            <div class="box-header">
	            <form action="<%=application.getContextPath() %>/app/admin/browse">
	              <div class="col-xs-3">
                ...
                <tbody>
	                <c:forEach items="${admins.data }" var="admin">
		                <tr>
		                  ...
		                  <td>
		                  	<a href="/manager/app/admin/find?id=${admin.id}">查看</a>
		                  	<a href="/manager/app/admin/edit?id=${admin.id}">编辑</a>
        ...
        <div class="box-footer">
          <ul class="pagination pagination-sm no-margin pull-right">
              <c:if test="${admins.curPage > 1 }">
              	<li><a href="<%=application.getContextPath() %>/app/admin/browse?page=${admins.curPage - 1}&keyword=${keyword}">上一页</a></li>
              </c:if>
              ...
              <c:if test="${admins.curPage < admins.totalPage }">
              	<li><a href="<%=application.getContextPath() %>/app/admin/browse?page=${admins.curPage + 1}&keyword=${keyword}">下一页</a></li>
              </c:if>
          </ul>
        </div>
        <!-- /.box-footer-->
...
<script src="<%=application.getContextPath() %>/admin/dist/js/admin.js"></script>
<script>
