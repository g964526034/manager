				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="link-effect-12">
						<ul class="nav navbar-nav w3_agile_nav">
							...
							<li class="active dropdown"><a href="/manager/announce/doUserBrowse.do"><span>小区公告</span></a></li>
	                ...
	                <tr>
	                  <c:forEach items="${announces.data }" var="announce">
		                <tr>
		                  ...
		                  <td>
		                  	<a href="/manager/announce/doUserFind.do?id=${announce.id}">查看</a>
		...
		<div class="box-footer">
			<ul class="pagination pagination-sm no-margin pull-right">
              <c:if test="${announces.curPage > 1 }">
              	<li><a href="<%=application.getContextPath() %>/announce/doUserBrowse.do?page=${announces.curPage - 1}&keyword=${keyword}">上一页</a></li>
              </c:if>
              
              <c:forEach begin="1" var="pageNum" end="${announces.totalPage }" step="1">
              	<li><a href="<%=application.getContextPath() %>/announce/doUserBrowse.do?page=${pageNum}&keyword=${keyword}">${pageNum }</a></li>
              </c:forEach>
              
              <c:if test="${announces.curPage < announces.totalPage }">
              	<li><a href="<%=application.getContextPath() %>/announce/doUserBrowse.do?page=${announces.curPage + 1}&keyword=${keyword}">下一页</a></li>
              </c:if>
          	</ul>
		</div>
	</div>
...
<!-- here stars scrolling icon -->
	...
	<script type="text/javascript" src="<%=application.getContextPath() %>/static/dist/js/announce.js"></script>
