  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <form id="add_cost_form" method="POST" action="/manager/cost/doAdd.do">
        	<div class="box-body">
	          <div class="row">
			    <div class="col-xs-3">
				...
				<div class="col-xs-6">
					<div class="box box-success">
						<label for="cost_name">费用名称</label>
						<input name="cost_name" id="cost_name" class="form-control" type="text" placeholder="费用名称">
						<br/>
						<label for="price">费用单价</label>
						<input name="price" id="price" class="form-control" type="text" placeholder="收费金额">
	        ...
	        <div class="box-footer">
				...
				<div class="col-xs-6" style="text-align:center;">
					<a type="button" href="/manager/cost/doBrowse.do" class="btn btn-default" style="margin-right:5px;">返回</a>
					<button type="submit" id="add_cost_btn" class="btn btn-primary" style="margin-left:5px;">确定</button> 
				</div>	
				<div class="col-xs-3">
...
<script src="/manager/static/dist/js/cost.js"></script>
<script>
