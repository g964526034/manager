...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form action="/manager/user/doEmaillogin.do" method="post">
      <div style="color:red;">${errInfo }</div>
      <div class="form-group has-feedback">
        <input name="email" type="text" class="form-control" placeholder="请输入Email账号">
    ...
    <div class="social-auth-links text-center">
		<p>- 其它登录方式 -</p>
		<a href="/manager/user/tellogin.do" class="btn btn-default btn-block">
			手机号登录
		</a>
