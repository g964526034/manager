	          ...
	          <div class="box">
				  ...
				  <div class="col-xs-6">
					<div class="box-body">
					  ...
					  <input name="house_message" id="house_message" class="form-control" type="text" placeholder="房屋信息" value="${user.houseMessage }">
					  <br/>
					  <label for="house_situation">房屋状态</label>
					  <div class="form-group">
						  <select name="house_situation" class="form-control">
					  ...
					  <input name="park_message" id="park_message" class="form-control" type="text" placeholder="车位信息" value="${user.parkMessage }">
					  <br/>
					  <div class="form-group">
						<label for="more">备注</label>
						<textarea name="more" id="more" class="form-control" rows="3" placeholder="Enter ...">${user.more }</textarea>
					  </div>
        	...
        	<div class="box-footer">
	          <div class="col-xs-3">
				...
				<div class="col-xs-6" style="text-align:center;">
					<a href="/manager/app/user/browse" type="button" class="btn btn-default" style="margin-right:5px;">返回</a>
					<button type="button" id="update_user_btn" class="btn btn-primary" style="margin-left:5px;">确定</button> 
				</div>
...
<script src="/manager/admin/dist/js/user.js"></script>
<script>
