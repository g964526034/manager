  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <form id="update_admin_form" method="POST" action="/manager/admin/doUpdate.do">
        	<div class="box-body">
	          <div class="box">
	              <div class="col-xs-3">
        	...
        	<div class="box-footer">
	          <div class="col-xs-3">
				...
				<div class="col-xs-6" style="text-align:center;">
					<a href="/manager/admin/doBrowse.do" type="button" class="btn btn-default" style="margin-right:5px;">返回</a>
...
<script src="/manager/static/dist/js/admin.js"></script>
<script>
