        ...
        <form id="update_user_form" method="POST" action="/manager/app/user/update">
					...
					<div class="box-body">
					  ...
					  <div class="form-group">
						  <select disabled name="marriage" class="form-control">
							<option value="0" <c:if test="${admin.gender == 0 }"> selected </c:if>>未婚</option>
							<option value="1" <c:if test="${admin.gender == 1 }"> selected </c:if>>已婚</option>
						  </select>
					  </div>
	        ...
	        <div class="box-footer">
				...
				<div class="col-xs-6" style="text-align:center;">
					...
					<a href="/manager/app/admin/edit?id=${admin.id}" type="button" class="btn btn-primary" style="margin-left:5px;">编辑</a> 
				</div>
