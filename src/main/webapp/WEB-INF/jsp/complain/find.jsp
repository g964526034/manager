        ...
        <div class="box-body">
			...
			<form id="response_complain_form" action="/manager/complain/doResponse.do" method="post">
				...
				<div  class="form-group">
				  ...
				  <textarea readonly name="response" id="response" style="height:175px;" class="form-control" rows="3" placeholder="Enter ..." >${complain.response }</textarea>
	            </div>
	            <div class="col-xs-3">
								  
				</div>
				<div class="col-xs-6" style="text-align:center;">
					<a href="/manager/complain/doBrowse.do" type="button" class="btn btn-default" style="margin-right:5px;">返回</a>
					<a href="/manager/complain/edit.do?id=${complain.id}" type="button" class="btn btn-primary" style="margin-left:5px;">确定</a> 
				</div>
				<div class="col-xs-3">	
